...
'not_language': "Не похоже, что была нажата одна из предложенных кнопок",

'/set_time' : """ message too long""",
'/set_language' : """Выбери язык с помощью кнопки. В скобках указано количество слов по уровням (лёгкий/нормальный/сложный).
<b>RUS</b> - русский, (2050/3106/2410)
<b>ENG</b> - английский, (2108/3981/4695)
<b>TAU</b> - карачаево-балкарский, В ПРОЦЕССЕ""",
}
